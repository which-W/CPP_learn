...
class CircularQueMseq :private std::allocator<T> {
public:
    CircularQueMseq() :_max_size(Cap + 1), _data(std::allocator<T>::allocate(_max_size)), _atomic_using(false), _head(0), _tail(0) {}
    CircularQueMseq(const CircularQueMseq&) = delete;
    CircularQueMseq& operator = (const CircularQueMseq&) volatile = delete;
    CircularQueMseq& operator = (constCircularQueMseq&) = delete;
